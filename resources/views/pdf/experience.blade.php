                                      ...
                                      <table role="panel" cellspacing="0" cellpadding="0" border="0" align="left" style="width:100%; height: 100%; margin: 50px auto 0px auto;">
                                          <tr class="second-icons-row" style="height: 100%;">
                                              <td width="auto" align="center" valign="top">
                                                <img src="http://cadizturismo.jekyllme.com/storage/app/media/uploaded-files/templates/ubicacion.svg" style="margin: -5px 0px;">
                                                <p class="tag-bottom">Conil</p>
                                              </td>
                                              <td width="auto" align="center" valign="top">
                                                <img src="http://cadizturismo.jekyllme.com/storage/app/media/uploaded-files/templates/ubicacion.svg" alt="" style="margin: -5px 0px;">
