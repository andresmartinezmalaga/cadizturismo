...
var ams = function(){
    ...
    var pMunicipio = '<!-- HEADER --> <div class="plantillaMunicipio header header-village"> <div class="header-container header-village-container"> <div class="header-txt header-txt-village"> <h1 class="txt">Nombre del municipio</h1><img class="brush fr-fil fr-dib" src="/storage/app/media/uploaded-files/templates/brush-header.svg" alt=""></div> </div> <!-- NUEVA FOTO --> <img class="background-image" value="cover" src="/storage/app/media/uploaded-files/templates/barbate1.jpg" alt=""> </div> <p class="mock"></p> <!-- TXT--> <div class="section-txt-village"> <div class="txt-container"> <h3 class="title">TITULAR</h3><img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/big-yellow-separator.svg"> <p class="desc">Escribe aquí el contenido a desarrollar y agrega una imagen adicional si lo necesitas.</p> </div> </div> <p class="mock-insert"><br></p> <!-- IMAGEN --> <div class="img-village"> <div class="txt-container"> <p class="title">Título del destacado</p> <p class="desc">Puedes destacar una ruta, una playa o un evento. Escribe una breve descripción sobre el enlace que vas a sugerir.</p> <a class="events-link" href="rutas.html">Conocer <img src="/storage/app/media/uploaded-files/templates/link-arrow-yellow.svg" alt="" class="fr-fic fr-dii">&nbsp;</a> <img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/big-yellow-separator.svg"></div> <!-- NUEVA FOTO --> <img class="img-destacada" src="/storage/app/media/uploaded-files/templates/marismas-barbate.jpg" alt=""> </div> <p class="mock-insert"><br></p> <div class="section-txt-village"> <div class="txt-container"> <h3 class="title">EXPERIENCIAS <br>EN (MUNICIPIO)</h3><img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/big-yellow-separator.svg"> </div> </div> <div class="all-exps"> <div class="all-events-container"> <div class="event"> <div class="overlay-img"> <br> </div><img class="rec-img fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/atun.jpg"> <div class="txt-container"> <p class="name">TÍTULO EXPERIENCIA 1</p><img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/small-yellow-separator.svg"> <div class="icons"> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/calendar-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Nº días</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/cultura-event.svg" class="fr-fil fr-dib"> <p class="icon-txt">Tipo de visita</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/natu-events.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 1</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/gastro-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 2</p> </div> </div> <div class="button-container"><a class="see-event" href="#">Ver experiencia <img src="/storage/app/media/uploaded-files/templates/link-icon.svg" class="fr-fic fr-dii"></a></div> </div> </div> <div class="event"> <div class="overlay-img"> <br> </div><img class="rec-img fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/faro.jpg"> <div class="txt-container"> <p class="name">TÍTULO EXPERIENCIA 2</p><img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/small-yellow-separator.svg"> <div class="icons"> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/calendar-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Nº días</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/cultura-event.svg" class="fr-fil fr-dib"> <p class="icon-txt">Tipo de visita</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/cultura-event.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 1</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/ocio-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 2</p> </div> </div> <div class="button-container"><a class="see-event" href="#">Ver experiencia <img src="/storage/app/media/uploaded-files/templates/link-icon.svg" class="fr-fic fr-dii"></a></div> </div> </div> <div class="event"> <div class="overlay-img"> <br> </div><img class="rec-img fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/brena.jpg"> <div class="txt-container"> <p class="name">TÍTULO EXPERIENCIA 3</p><img class="separator fr-fic fr-dii" src="/storage/app/media/uploaded-files/templates/small-yellow-separator.svg"> <div class="icons"> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/calendar-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Nº días</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/cultura-event.svg" class="fr-fil fr-dib"> <p class="icon-txt">Tipo de visita</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/natu-events.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 1</p> </div> <div class="icon-pair"><img src="/storage/app/media/uploaded-files/templates/ruta-exp.svg" class="fr-fil fr-dib"> <p class="icon-txt">Interés 2</p> </div> </div> <div class="button-container"><a class="see-event" href="#">Ver experiencia <img src="/storage/app/media/uploaded-files/templates/link-icon.svg" class="fr-fic fr-dii"></a></div> </div> </div> </div> </div>';
    ...
    this.reloadTemplate = function(e){
        ...
        if(element.find('.plantillaMunicipio').length>0){
            element.html(pMunicipio);
        }       
