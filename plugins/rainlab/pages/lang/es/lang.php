...
return [
    ...
    'experience' => [
        ...
        'no_records' => 'No se ha encontrado ninguna experiencia',
        'delete_confirm_single' => 'Estas seguro de querer borrar esta experiencia? Esto también borrará las sub-experiencias que existan.',
        'new' => 'Nueva experiencia',
        'add_subpage' => 'Añadir sub-experiencia',
        'invalid_url' => 'Formato de URL no válido. La URL debería comenzar por una barra (\'/\'). Puede contener letras, números, y los siguientes símbolos  _ - / ',
        'url_not_unique' => 'Esta URL ya está siendo utilizada por otra experiencia.',
        'layout' => 'Plantilla',
        'layouts_not_found' => 'No se han encontrado plantillas',
        'saved' => 'La experiencia se ha guardado correctamente.',
        'tab' => 'experiencias',
        'manage_pages' => 'Administrar experiencias',
        'manage_menus' => 'Administrar menús',
        'access_snippets' => 'Acceder a fragmentos',
        'manage_content' => 'Administrar contenidos',
