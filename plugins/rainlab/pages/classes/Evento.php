...
use RainLab\Pages\Classes\EventoList;
...
class Evento extends ContentBase
{
    ...
    {
        $pages = Evento::listInTheme($this->theme, true);
    ...
    {
        $eventList = new EventoList($this->theme);
        $eventList->appendPage($this);
    }
    ...
    public function setDefaultLayout($parentPage)
    {
        ...
        if ($parentPage) {
            ...
            $component = $layout ? $layout->getComponent('staticEvento') : null;
    ...
    public function getLayoutOptions()
    {
        ...
        foreach ($layouts as $layout) {
            if (!$layout->hasComponent('staticEvento')) {
                continue;
            }
    ...
    public static function buildMenuTree($theme)
    {
        ...
        $eventList = new EventoList($theme);
