  ...
  <div class=\"header-container big-div\">
    <div id=\"exp-header\" class=\"header-txt\">
      <p class=\"txt\"><span id=\"exp\" class=\"first-word\">";
        // line 6
        echo call_user_func_array($this->env->getFilter('_')->getCallable(), array("Experiencias"));
        echo "</span> ";
        echo call_user_func_array($this->env->getFilter('_')->getCallable(), array("pensadas para ti"));
        echo "</p>
        <img class=\"brush\" src=\"";
        // line 7
        echo url("/");
